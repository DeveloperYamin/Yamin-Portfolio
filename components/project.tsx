...
import { FiHeart, FiBookmark, FiExternalLink, FiCode } from "react-icons/fi";
  ...
  return (
    ...
    >
      <section className="bg-gray-100 max-w-[42rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        ...
        {isHovered && (
          <div className="absolute inset-0 flex items-center bg-black/10 transition-opacity gap z-50 justify-evenly">
            <a
              className="bg-white/40 p-3 rounded-full cursor-pointer"
              target="_blank"
